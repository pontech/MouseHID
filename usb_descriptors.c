...
#define CLASS_MSD					0x08

/* HID Interface Class SubClass Codes */
#define HID_SUBCLASS_NONE				0x00
#define HID_SUBCLASS_BOOT_INTF          0x01
...
// Endpoint defines (or together to use)
#define EP_OUT						0x00
#define EP_IN						0x80
...
ROM BYTE configDescriptor1[]={
	...
	USB_DESCRIPTOR_CONFIGURATION, 	// bDescriptorType     - descriptor type
	0x09+0x09+0x09+0x07, 0x00,                    // wTotalLength        - total length of config, interface, HID and endpoint descriptors
	0x01,                           // bNumInterfaces      - number of interfaces
	0x01,                           // bConfigurationValue - configuration number
	0x00,                           // iConfiguration      - index to string that describes configuration (none)
	0xA0,                           // bmAttributes        - configuration attributes , remote wakeup
	  50,                           // bMaxPower           - current consumption in 2mA units (100 mA)
	...
	0x01,                           // bNumEndpoints        - number of endpoints used by interface
	CLASS_HID,                      // bInterfaceClass      - class code
	HID_SUBCLASS_BOOT_INTF,         // bInterfaceSubClass   - subclass code
	HID_PROTOCOL_MOUSE,             // bInterfaceProtocol   - protocol (mouse)
  	0x00,                           // iInterface           - index to string that describes interface
